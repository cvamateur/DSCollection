...
class TASK:
    ...
    1. extract:
        ...
        The task requires one or more input datasets, each can be of any type,
        like VOC | KITTI | COCO, etc. After extraction process complete, final
        output could be either VOC or KITTI.
    ...
    4. split:
        ...
        There are three options to split a dataset:
            - Specify number partitions:
                -ns/--num-splits
            - Specify number images per each partition:
                -ne/--num-per-each
            - Specify percentage of each part:
                -nf/--num-fractions
